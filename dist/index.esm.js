    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$s, { width: "24px", color: "#0085FF" }))))));
};
var templateObject_1$G, templateObject_2$h, templateObject_3$7, templateObject_4$5, templateObject_5$4;
...
var BoxLink = styled(Link)(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-left: 6px;\n  margin-right: 0px;\n"], ["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-left: 6px;\n  margin-right: 0px;\n"])), function (_a) {
    var theme = _a.theme;
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(BoxLink, __assign({ external: true }, props),
        children,
        React.createElement(Icon$i, { width: "20px", color: "#0085FF" })));
};
var templateObject_1$l;
...
var RotatingPancakeIcon = styled(Icon$2)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled(Icon$3)(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var templateObject_1$i, templateObject_2$b, templateObject_3$6, templateObject_4$4, templateObject_5$3;
...
var templateObject_1$h, templateObject_2$a, templateObject_3$5, templateObject_4$3, templateObject_5$2;
...
var StyleWarningModalIcon = styled(Icon$4)(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  fill: #FFA14E;\n  width: 28px;\n  height: 28px;\n  margin-right: 20px;\n  display: inline-block;\n  position: relative;\n  top: 10px;\n  ", " {\n    width: 40px;\n    height: 37px;\n    margin-right: 34px;\n  }\n"], ["\n  fill: #FFA14E;\n  width: 28px;\n  height: 28px;\n  margin-right: 20px;\n  display: inline-block;\n  position: relative;\n  top: 10px;\n  ", " {\n    width: 40px;\n    height: 37px;\n    margin-right: 34px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
        ...
        React.createElement(ModalHeader, null,
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconButtonStyle, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$H, { color: "#FFFFFF" }))),
            ...
            !hideCloseButton && (React.createElement(IconButtonStyle, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$s, { color: "#FFFFFF" })))),
...
React.memo(Logo$2, function (prev, next) { return prev.isDark === next.isDark; });

var Icon$1 = function (props) {
    return (React.createElement("svg", { width: "80", height: "80", viewBox: "0 0 1000 1000", fill: "none", xmlns: "http://www.w3.org/2000/svg" },
        React.createElement("circle", { cx: "500", cy: "500", r: "500", fill: "white" }),
        React.createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M433.402 107L330 318.375V724.672V886.574V893.315H495.672V893.031L495.832 893.201L649.005 803.51L661.117 741.437L588.906 628.468L473.429 602.147L542.289 391.157L669 473.422L578.351 245.623L457.697 334.072L433.402 107ZM594.671 700.525L563.159 652.691L515.325 684.203L546.837 732.037L594.671 700.525Z", fill: "#0C2A54" }),
        React.createElement("path", { d: "M383.015 582.537L450.655 597.733L458.996 383.959L383.015 582.537Z", fill: "#F47820" })));
};
...
var Logo = function (_a) {
    _a.isPushed; _a.togglePush; var href = _a.href, isDark = _a.isDark;
    var isAbsoluteUrl = href.startsWith("http");
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement("span", { className: "desktop-icon-text" },
            React.createElement(Icon$1, { width: "166", color: isDark ? '#FFFFFF' : '#605E77' }))));
    return (React.createElement(StyleFlex, null, isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href }, innerLogo)) : (React.createElement(StyledLink, { to: href }, innerLogo))));
};
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        React.createElement(StyleContent, null, connectors.map(function (entry, index) { return (React.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); }))));
};
var templateObject_1$a, templateObject_2$5;

var StyleButton$1 = styled(Text).attrs({ role: "button" })(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-right: 6px;\n"], ["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-right: 6px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? '#151C31' : '#E9F4FC';
});
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton$1, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$p, { width: "20px", color: "#0085FF" }),
...
var StyleButton = styled(Button)(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 20px;\n  height: 37px;\n  font-size: 13px;\n  ", " {\n    min-width: 150px;\n    height: 56px;\n    font-size: 16px;\n  }\n  &.btn-onPresentAccountModal {\n    background: #EFF4F5;\n    color: #6F6C99;\n    box-shadow: none;\n    width: 90px;\n  }\n  \n  &.btn-onPresentConnectModal {\n    background: #0085FF;\n    box-shadow: 0px 4px 10px rgba(83, 185, 234, 0.24);\n    width: 90px;\n  }\n"], ["\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 20px;\n  height: 37px;\n  font-size: 13px;\n  ", " {\n    min-width: 150px;\n    height: 56px;\n    font-size: 16px;\n  }\n  &.btn-onPresentAccountModal {\n    background: #EFF4F5;\n    color: #6F6C99;\n    box-shadow: none;\n    width: 90px;\n  }\n  \n  &.btn-onPresentConnectModal {\n    background: #0085FF;\n    box-shadow: 0px 4px 10px rgba(83, 185, 234, 0.24);\n    width: 90px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", null, account ? (React.createElement(StyleButton, { className: "btn-onPresentAccountModal", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React.createElement(StyleButton, { className: "btn-onPresentConnectModal", onClick: function () {
...
var StyleText = styled(Text)(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  color: ", ";\n  font-size: 13px;\n  letter-spacing: -0.03em;\n  ", " {\n    font-size: 16px;\n    color: ", ";\n  }\n"], ["\n  color: ", ";\n  font-size: 13px;\n  letter-spacing: -0.03em;\n  ", " {\n    font-size: 16px;\n    color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? '#FFFFFF' : '#FFFFFF';
}, function (_a) {
    var theme = _a.theme;
...
var StyleNoProfileAvatar = styled(Icon$j)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  width: 37px;\n  height: 37px;\n  fill: #E2E2E8;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"], ["\n  width: 37px;\n  height: 37px;\n  fill: #E2E2E8;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
styled(Text)(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  color: ", ";\n  font-size: 18px;\n  letter-spacing: -0.03em;\n  ", " {\n    font-size: 16px;\n    color: ", ";\n  }\n"], ["\n  color: ", ";\n  font-size: 18px;\n  letter-spacing: -0.03em;\n  ", " {\n    font-size: 16px;\n    color: ",
    ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return (theme.isDark ? "#FFFFFF" : "#FFFFFF");
}, function (_a) {
...
var Block = styled.div(templateObject_2$1 || (templateObject_2$1 = __makeTemplateObject(["\n  color: ", ";\n  font-size: 18px;\n  font-weight: 700;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  margin-right: 8px;\n  .balance {\n    cursor: pointer;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    gap: 8px;\n  }\n  .detail {\n    font-size: 14px;\n    text-align: center;\n    div {\n      padding: 4px;\n    }\n  }\n"], ["\n  color: ", ";\n  font-size: 18px;\n  font-weight: 700;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  margin-right: 8px;\n  .balance {\n    cursor: pointer;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    gap: 8px;\n  }\n  .detail {\n    font-size: 14px;\n    text-align: center;\n    div {\n      padding: 4px;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return (theme.isDark ? "#FFFFFF" : "#6F6C99");
});
var Add = styled.div(templateObject_3$1 || (templateObject_3$1 = __makeTemplateObject(["\n  width: 26px;\n  height: 26px;\n  font-size: 24px;\n  text-aligh: center;\n  border-radius: 4px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background: ", ";\n  color: ", ";\n  margin-right: 12px;\n"], ["\n  width: 26px;\n  height: 26px;\n  font-size: 24px;\n  text-aligh: center;\n  border-radius: 4px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background: ", ";\n  color: ", ";\n  margin-right: 12px;\n"])), function (_a) {
    var theme = _a.theme;
    return (theme.isDark ? "#FFFFFF" : "#6F6C99");
}, function (_a) {
    var theme = _a.theme;
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme; _a.langs; _a.setLang; _a.currentLang; _a.cakePriceUsd; var links = _a.links; _a.linkMyPage; var profile = _a.profile, children = _a.children, balance = _a.balance;
    ...
    return (React.createElement(Wrapper, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, { alignItems: "center" },
                React.createElement(Balance, { balance: balance }),
...
export { Icon$I as AddIcon, Alert, Icon$H as ArrowBackIcon, Icon$G as ArrowDownIcon, Icon$F as ArrowDropDownIcon, Icon$E as ArrowDropUpIcon, Icon$D as ArrowForwardIcon, Icon$C as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$B as BinanceIcon, Icon$K as BlockIcon, Box, Breadcrumbs, Icon$A as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$y as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$z as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$M as CheckmarkCircleIcon, Icon$x as CheckmarkIcon, Icon$w as ChevronDownIcon, Icon$v as ChevronLeftIcon, Icon$u as ChevronRightIcon, Icon$t as ChevronUpIcon, Icon$s as CloseIcon, Icon$r as CogIcon, Icon$q as CommunityIcon, ConnectorNames, Icon$p as CopyIcon, Dropdown, Icon$L as ErrorIcon, FallingBunnies, Flex, Heading, Icon$o as HelpIcon, IconButton, Image, Icon$J as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$n as ListViewIcon, Icon$m as LogoIcon, Icon$l as LogoRoundIcon, Menu, Icon$k as MinusIcon, Modal, ModalProvider, Icon$j as NoProfileAvatarIcon, Icon$i as OpenNewIcon, Icon$g as PancakeRoundIcon, Icon$h as PancakesIcon, Icon$f as PrizeIcon, Progress, Icon$c as ProgressBunny, Radio, Icon$e as RemoveIcon, ResetCSS, Icon$8 as SearchIcon, Skeleton, Spinner, Svg, Icon$7 as SwapVertIcon, Icon$6 as SyncAltIcon, Tag, Text, Icon$a as Ticket, Icon$9 as TicketRound, ToastContainer, Toggle, Icon$d as VerifiedIcon, Icon$5 as WarningIcon, Icon$4 as WarningModalIcon, Icon$b as Won, variants as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
