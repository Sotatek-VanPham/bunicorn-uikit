    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$A, { width: "24px", color: "#0085FF" }))))));
};
...
var DefaultSeparator = React.createElement(Icon$C, { color: "currentColor", width: "24px" });
...
var BoxLink = styled(Link)(templateObject_1$n || (templateObject_1$n = __makeTemplateObject(["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-left: 6px;\n  margin-right: 0px;\n"], ["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-left: 6px;\n  margin-right: 0px;\n"])), function (_a) {
    var theme = _a.theme;
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(BoxLink, __assign({ external: true }, props),
        children,
        React.createElement(Icon$q, { width: "20px", color: "#0085FF" })));
};
var templateObject_1$n;
...
var FloatingPanIcon = styled(Icon$b)(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var StyleWarningModalIcon = styled(Icon$c)(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  fill: #FFA14E;\n  width: 28px;\n  height: 28px;\n  margin-right: 20px;\n  display: inline-block;\n  position: relative;\n  top: 10px;\n  ", " {\n    width: 40px;\n    height: 37px;\n    margin-right: 34px;\n  }\n"], ["\n  fill: #FFA14E;\n  width: 28px;\n  height: 28px;\n  margin-right: 20px;\n  display: inline-block;\n  position: relative;\n  top: 10px;\n  ", " {\n    width: 40px;\n    height: 37px;\n    margin-right: 34px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
    ...
    return (React.createElement(StyledModal, null,
        React.createElement(ModalHeader, null,
            ...
            !hideCloseButton && (React.createElement(IconButtonStyle, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$A, { color: "#FFFFFF" })))),
...
var Logo = function (_a) {
    ...
    var innerLogo = (React.createElement(React.Fragment, null,
        React.createElement("span", { className: "desktop-icon-text" },
            React.createElement(Icon$7, { width: "166", color: isDark ? '#FFFFFF' : '#605E77' }))));
    return (React.createElement(StyleFlex, null,
        React.createElement(MenuButton, { className: "btn-toggle-menu", "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$8, { width: "24px", color: "#5F5E76" })) : (React.createElement(Icon$9, { width: "24px", color: "#0085FF" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href }, innerLogo)) : (React.createElement(StyledLink, { to: href }, innerLogo))));
};
...
var ButtonStyle = styled(Button)(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  background: ", ";\n  height: 60px;\n  justify-content: flex-start;\n  margin-bottom: 15px;\n  width: 410px;\n  max-width: 100%;\n  svg {\n    width: 34px;\n    margin-right: 23px;\n  }\n  ", " {\n    height: 70px;\n    svg {\n      width: 40px;\n      margin-right: 43px;\n    }\n  }\n"], ["\n  background: ", ";\n  height: 60px;\n  justify-content: flex-start;\n  margin-bottom: 15px;\n  width: 410px;\n  max-width: 100%;\n  svg {\n    width: 34px;\n    margin-right: 23px;\n  }\n  ", " {\n    height: 70px;\n    svg {\n      width: 40px;\n      margin-right: 43px;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? '#151C31' : '#E9F4FC';
}, function (_a) {
    var theme = _a.theme;
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        React.createElement(StyleContent, null,
            ...
            React.createElement(HelpLink, { href: "https://smart-dex29.gitbook.io/smartdex-v2/general-faq#how-do-i-connect-my-wallet-to-smartdex", external: true },
                ...
                React.createElement(Icon$w, { color: "#0085FF", ml: "12px" })))));
};
var templateObject_1$b, templateObject_2$6;

var StyleButton$2 = styled(Text).attrs({ role: "button" })(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-right: 6px;\n"], ["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-right: 6px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? '#151C31' : '#E9F4FC';
});
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton$2, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$x, { width: "20px", color: "#0085FF" }),
        React.createElement(Tooltip, { isTooltipDisplayed: isTooltipDisplayed }, "Copied")));
};
var templateObject_1$a, templateObject_2$5;

var BoxText = styled.div(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  background: ", ";\n  width: 468px;\n  max-width: 100%;\n  height: 70px;\n  border-radius: 20px;\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  padding: 10px 20px;\n  margin-bottom: 20px;\n  > div {\n    margin-bottom: 0px !important;\n    color: ", " !important;\n    font-weight: 600;\n    font-size: 14px !important;\n    line-height: 17px;\n  }\n"], ["\n  background: ", ";\n  width: 468px;\n  max-width: 100%;\n  height: 70px;\n  border-radius: 20px;\n  display: flex;\n  justify-content: flex-start;\n  align-items: center;\n  padding: 10px 20px;\n  margin-bottom: 20px;\n  > div {\n    margin-bottom: 0px !important;\n    color: ", " !important;\n    font-weight: 600;\n    font-size: 14px !important;\n    line-height: 17px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? '#151C31' : '#E9F4FC';
}, function (_a) {
    var theme = _a.theme;
...
var StyleButton$1 = styled(Button)(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 20px;\n  height: 37px;\n  font-size: 13px;\n  ", " {\n    min-width: 150px;\n    height: 56px;\n    font-size: 16px;\n  }\n  &.btn-onPresentAccountModal {\n    background: #EFF4F5;\n    color: #6F6C99;\n    box-shadow: none;\n    width: 90px;\n  }\n  \n  &.btn-onPresentConnectModal {\n    background: #0085FF;\n    box-shadow: 0px 4px 10px rgba(83, 185, 234, 0.24);\n    width: 90px;\n  }\n"], ["\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 20px;\n  height: 37px;\n  font-size: 13px;\n  ", " {\n    min-width: 150px;\n    height: 56px;\n    font-size: 16px;\n  }\n  &.btn-onPresentAccountModal {\n    background: #EFF4F5;\n    color: #6F6C99;\n    box-shadow: none;\n    width: 90px;\n  }\n  \n  &.btn-onPresentConnectModal {\n    background: #0085FF;\n    box-shadow: 0px 4px 10px rgba(83, 185, 234, 0.24);\n    width: 90px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
var StyleText = styled(Text)(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  color: ", ";\n  font-size: 13px;\n  letter-spacing: -0.03em;\n  ", " {\n    font-size: 16px;\n    color: ", ";\n  }\n"], ["\n  color: ", ";\n  font-size: 13px;\n  letter-spacing: -0.03em;\n  ", " {\n    font-size: 16px;\n    color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? '#FFFFFF' : '#FFFFFF';
}, function (_a) {
    var theme = _a.theme;
...
var StyleButton = styled(Button)(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  border: 1px solid  ", ";\n  border-radius: 50px;\n  margin-right: 20px;\n  height: 37px;\n  padding-left: 16px;\n  padding-right: 16px;\n  > div {\n    font-size: 13px;\n    color: ", ";\n  }\n  ", " {\n    min-width: 150px;\n    height: 56px;\n    > div {\n      font-size: 16px;\n    }\n  }\n"], ["\n  border: 1px solid  ", ";\n  border-radius: 50px;\n  margin-right: 20px;\n  height: 37px;\n  padding-left: 16px;\n  padding-right: 16px;\n  > div {\n    font-size: 13px;\n    color: ", ";\n  }\n  ", " {\n    min-width: 150px;\n    height: 56px;\n    > div {\n      font-size: 16px;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? '#2F344B' : '#E2E2E8';
}, function (_a) {
    var theme = _a.theme;
...
var StyleChevronDownIcon = styled(Icon$E)(templateObject_2$3 || (templateObject_2$3 = __makeTemplateObject(["\n  color: ", ";\n"], ["\n  color: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? 'rgba(255, 255, 255, 0.87)' : '#6F6C99';
});
...
var StyleNoProfileAvatar = styled(Icon$r)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  width: 37px;\n  height: 37px;\n  fill: #E2E2E8;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"], ["\n  width: 37px;\n  height: 37px;\n  fill: #E2E2E8;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
var Balance = function (_a) {
    ...
    return (React.createElement(Block, null,
        React.createElement(Dropdown, { position: "bottom", target: React.createElement(Add, null,
                React.createElement("a", { href: "https://bunicorn.exchange/#/trade/tokens", target: "_blank" }, "+")) },
...
export { Icon$Q as AddIcon, Alert, Icon$P as ArrowBackIcon, Icon$O as ArrowDownIcon, Icon$N as ArrowDropDownIcon, Icon$M as ArrowDropUpIcon, Icon$L as ArrowForwardIcon, Icon$K as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$J as BinanceIcon, Icon$S as BlockIcon, Box, Breadcrumbs, Icon$I as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$G as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$H as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$U as CheckmarkCircleIcon, Icon$F as CheckmarkIcon, Icon$E as ChevronDownIcon, Icon$D as ChevronLeftIcon, Icon$C as ChevronRightIcon, Icon$B as ChevronUpIcon, Icon$A as CloseIcon, Icon$z as CogIcon, Icon$y as CommunityIcon, ConnectorNames, Icon$x as CopyIcon, Dropdown, Icon$T as ErrorIcon, FallingBunnies, Flex, Heading, Icon$w as HelpIcon, IconButton, Image, Icon$R as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$v as ListViewIcon, Icon$u as LogoIcon, Icon$t as LogoRoundIcon, Menu, Icon$s as MinusIcon, Modal, ModalProvider, Icon$r as NoProfileAvatarIcon, Icon$q as OpenNewIcon, Icon$o as PancakeRoundIcon, Icon$p as PancakesIcon, Icon$n as PrizeIcon, Progress, Icon$k as ProgressBunny, Radio, Icon$m as RemoveIcon, ResetCSS, Icon$g as SearchIcon, Skeleton, Spinner, Svg, Icon$f as SwapVertIcon, Icon$e as SyncAltIcon, Tag, Text, Icon$i as Ticket, Icon$h as TicketRound, ToastContainer, Toggle, Icon$l as VerifiedIcon, Icon$d as WarningIcon, Icon$c as WarningModalIcon, Icon$j as Won, variants as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
