    ...
    return (React__default['default'].createElement(StyledAlert, null,
        ...
        onClick && (React__default['default'].createElement(CloseHandler, null,
            React__default['default'].createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React__default['default'].createElement(Icon$s, { width: "24px", color: "#0085FF" }))))));
};
...
var BoxLink = styled__default['default'](Link)(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-left: 6px;\n  margin-right: 0px;\n"], ["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-left: 6px;\n  margin-right: 0px;\n"])), function (_a) {
    var theme = _a.theme;
...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(BoxLink, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$i, { width: "20px", color: "#0085FF" })));
};
var templateObject_1$l;
...
var RotatingPancakeIcon = styled__default['default'](Icon$2)(templateObject_4$4 || (templateObject_4$4 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
var FloatingPanIcon = styled__default['default'](Icon$3)(templateObject_5$3 || (templateObject_5$3 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
...
var StyleWarningModalIcon = styled__default['default'](Icon$4)(templateObject_6$1 || (templateObject_6$1 = __makeTemplateObject(["\n  fill: #FFA14E;\n  width: 28px;\n  height: 28px;\n  margin-right: 20px;\n  display: inline-block;\n  position: relative;\n  top: 10px;\n  ", " {\n    width: 40px;\n    height: 37px;\n    margin-right: 34px;\n  }\n"], ["\n  fill: #FFA14E;\n  width: 28px;\n  height: 28px;\n  margin-right: 20px;\n  display: inline-block;\n  position: relative;\n  top: 10px;\n  ", " {\n    width: 40px;\n    height: 37px;\n    margin-right: 34px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
        ...
        React__default['default'].createElement(ModalHeader, null,
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(IconButtonStyle, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$H, { color: "#FFFFFF" }))),
            ...
            !hideCloseButton && (React__default['default'].createElement(IconButtonStyle, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default['default'].createElement(Icon$s, { color: "#FFFFFF" })))),
...
var Logo = function (_a) {
    ...
    var innerLogo = (React__default['default'].createElement(React__default['default'].Fragment, null,
        React__default['default'].createElement("span", { className: "desktop-icon-text" },
            React__default['default'].createElement(Icon$1, { width: "166", color: isDark ? '#FFFFFF' : '#605E77' }))));
    return (React__default['default'].createElement(StyleFlex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href }, innerLogo)) : (React__default['default'].createElement(StyledLink, { to: href }, innerLogo))));
};
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        React__default['default'].createElement(StyleContent, null, connectors.map(function (entry, index) { return (React__default['default'].createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })); }))));
};
var templateObject_1$a, templateObject_2$5;

var StyleButton$1 = styled__default['default'](Text).attrs({ role: "button" })(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject(["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-right: 6px;\n"], ["\n  background: ", ";\n  width: 37px;\n  height: 37px;\n  border-radius: 50%;\n  line-height: 37px;\n  display: flex;\n  justify-content: center;\n  margin-right: 6px;\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? '#151C31' : '#E9F4FC';
});
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton$1, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$p, { width: "20px", color: "#0085FF" }),
...
var StyleButton = styled__default['default'](Button)(templateObject_1$7 || (templateObject_1$7 = __makeTemplateObject(["\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 20px;\n  height: 37px;\n  font-size: 13px;\n  ", " {\n    min-width: 150px;\n    height: 56px;\n    font-size: 16px;\n  }\n  &.btn-onPresentAccountModal {\n    background: #EFF4F5;\n    color: #6F6C99;\n    box-shadow: none;\n    width: 90px;\n  }\n  \n  &.btn-onPresentConnectModal {\n    background: #0085FF;\n    box-shadow: 0px 4px 10px rgba(83, 185, 234, 0.24);\n    width: 90px;\n  }\n"], ["\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 20px;\n  height: 37px;\n  font-size: 13px;\n  ", " {\n    min-width: 150px;\n    height: 56px;\n    font-size: 16px;\n  }\n  &.btn-onPresentAccountModal {\n    background: #EFF4F5;\n    color: #6F6C99;\n    box-shadow: none;\n    width: 90px;\n  }\n  \n  &.btn-onPresentConnectModal {\n    background: #0085FF;\n    box-shadow: 0px 4px 10px rgba(83, 185, 234, 0.24);\n    width: 90px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", null, account ? (React__default['default'].createElement(StyleButton, { className: "btn-onPresentAccountModal", onClick: function () {
            onPresentAccountModal();
        } }, accountEllipsis)) : (React__default['default'].createElement(StyleButton, { className: "btn-onPresentConnectModal", onClick: function () {
...
var StyleText = styled__default['default'](Text)(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject(["\n  color: ", ";\n  font-size: 13px;\n  letter-spacing: -0.03em;\n  ", " {\n    font-size: 16px;\n    color: ", ";\n  }\n"], ["\n  color: ", ";\n  font-size: 13px;\n  letter-spacing: -0.03em;\n  ", " {\n    font-size: 16px;\n    color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.isDark ? '#FFFFFF' : '#FFFFFF';
}, function (_a) {
    var theme = _a.theme;
...
var StyleNoProfileAvatar = styled__default['default'](Icon$j)(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  width: 37px;\n  height: 37px;\n  fill: #E2E2E8;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"], ["\n  width: 37px;\n  height: 37px;\n  fill: #E2E2E8;\n\n  ", " {\n    width: 56px;\n    height: 56px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.nav;
});
...
var Balance = function (_a) {
    ...
    return (React__default['default'].createElement(Block, null,
        React__default['default'].createElement(Dropdown, { position: "bottom", target: React__default['default'].createElement(Add, null,
                React__default['default'].createElement("a", { href: "https://bunicorn.exchange/#/trade/tokens?assetIn=bnb&assetOut=0xc1619D98847CF93d857DFEd4e4d70CF4f984Bd56", target: "_blank" }, "+")) },
...
exports.AddIcon = Icon$I;
exports.Alert = Alert;
exports.ArrowBackIcon = Icon$H;
exports.ArrowDownIcon = Icon$G;
exports.ArrowDropDownIcon = Icon$F;
exports.ArrowDropUpIcon = Icon$E;
exports.ArrowForwardIcon = Icon$D;
exports.AutoRenewIcon = Icon$C;
exports.BackgroundImage = BackgroundImage;
exports.BaseLayout = GridLayout$1;
exports.BinanceIcon = Icon$B;
exports.BlockIcon = Icon$K;
exports.Box = Box;
exports.Breadcrumbs = Breadcrumbs;
exports.BunnyPlaceholderIcon = Icon$A;
...
exports.CheckmarkCircleIcon = Icon$M;
